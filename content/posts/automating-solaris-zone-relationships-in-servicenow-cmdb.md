...
featured: false
---
## Automating Solaris Zone Relationships in ServiceNow CMDB
...
| --- | --- | --- |
| Server CI class | cmdb_ci_linux_server / cmdb_ci_win_server | cmdb_ci_solaris_server |
| Instance CI class | cmdb_ci_vm_instance | cmdb_ci_solaris_instance |
| Join key | object_id | name |
| Skip state | terminated | off |
| Relationship type | Virtualized by::Virtualizes | Virtualized by::Virtualizes |
